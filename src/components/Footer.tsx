...
function Footer() {
  return (
    <div className='w-screen py-[60px] flex flex-col bg-gradient-to-br from-dark_green to-light_green text-white items-center gap-[40] '>
        <div className="max-w-[1400px] w-full flex flex-col md:flex-row gap-[30px] ">
            <div className=" py-[50px]  flex flex-col justify-center gap-[20]  px-[30]">
                <h1>Contact Us</h1>
