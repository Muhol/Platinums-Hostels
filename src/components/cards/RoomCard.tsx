    ...
    <div title={title} className='bg-white flex flex-col w-[300px] h-[420px] p-[0px] rounded-lg border group hover:shadow-2xl transition-all duration-300 overflow-hidden' >
        ...
        <div className="flex bg-white z-10 flex-col gap-3 w-full flex-1 py-4 px-4 justify-between">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link href={`/Room_details?id=${props.id}`} className='md:hidden text-center w-full border-2 border-blue rounded text-blue hover:text-white hover:bg-blue font-semibold py-1.5 px-3 transition-all duration-300 '>
                  View Details 
              </Link>
            </div>
        </div>
